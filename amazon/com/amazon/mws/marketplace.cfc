<cfcomponent hint="Merchant Web Service Methods" extends="amazon.com.amazon.factory" output="false">
	...
	<cffunction name="init" access="public" returntype="void" output="false">
		...
		<cfargument name="ordersFlag" type="string" required="false" default="false" hint="Your Marketplace ID"/>
		<cfargument name="location" type="string" required="false" default="US" hint="US,UK,Germany,France,Japan,China,Canada"/>
		<cfscript>
			//Populate default properties
			if(ordersFlag){
				this.baseurl 			= "https://mws.amazonservices.com/Orders/2011-01-01";
			}else{
...
<!--- ORDERS --->
<cffunction name="GetServiceStatus" hint="returns the operational status of the Orders API section of Amazon Marketplace Web Service. Status values are GREEN, GREEN_I, YELLOW, and RED" access="public" output="false" returntype="struct">
	<cfscript>
		var qs	= "Action=GetServiceStatus";
		var i	= 0;
		var xml	= "";
		var out	= StructNew();
		var tmp	= StructNew();
	...
	<cffunction name="sendRequest" access="private" output="true" returntype="xml">
		...
		<br><br>
		[<cfdump var="#arguments.uri#" label="arguments.uri">]<br>
		[<cfdump var="#arguments.method#" label="arguments.method">]<br>
		[<cfdump var="#arguments.body#" label="arguments.body">]<br>
	...
	<cffunction name="getSignedURL" returnType="string" output="false">
		...
		<cfscript>
			...
			//cqs = listappend(cqs,"Merchant="&this.merchantId,"&"); //old
			cqs = listappend(cqs,"SellerId="&this.merchantId,"&");
