<!---
2016-03-05
Note: Vlad changed this to use the izhuk image editor.
...
<cfset tmpFile = "#path#\#attributes.item#_#attributes.imgnum#.jpg">	

<cfimage 
	source="#trim(attributes.BASE64DATA)#"  
	action="write" 
	destination="#tmpFile#" 
	isbase64="yes" 
	overwrite="yes" >	
...
<cfoutput>
	<cfdump var="#path#\#attributes.item#_#attributes.imgnum#.jpg">	 
	<img src="http://www.instantonlineconsignment.com/images/#attributes.item#/#attributes.item#_#attributes.imgnum#.jpg" />
...
<cfoutput>
##SHOWDOCUMENT=/index.cfm?dsp=admin.auctions.step3&item=#attributes.item#&imgnum=#attributes.imgnum#&from=#attributes.from#&doNotResize=#attributes.doNotResize#



<!--- reloacate to the step3 --->
<cflocation url="index.cfm?dsp=admin.auctions.step3&item=#attributes.item#" addtoken="no">
