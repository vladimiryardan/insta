...
<cfelse>
	...
	<cffile action="delete" file='#replaceNoCase("#request.basepath##_layout.images_path##attributes.item#\#attributes.imgnum#.jpg","\","/")#'>
	<cffile action="delete" file='#replaceNoCase("#request.basepath##_layout.images_path##attributes.item#\#attributes.imgnum#thumb.jpg",'\',"/")#'>
</cfif>
