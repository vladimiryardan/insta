...
####################
--->	
<cffunction name="getRatesByOneRate" access="public" returntype="struct" output="true">
		<!---Shipper (Sender) Details--->
		<cfargument name="shipperAddress1" type="string" default="" />
		<cfargument name="shipperAddress2" type="string" default="" />
		<cfargument name="shipperCity" type="string" default="" />
		...
		<!---Extra Options--->
		<cfargument name="returnRawResponse" type="boolean" required="no" default="false" />
		<cfargument name="fedexServiceType" type="any" required="no"  />
			...
			<ns:RateRequest>
			  ...
			  <ns:Version>
				...
				<ns:RequestedShipment>
					<ns:ShipTimestamp>#DateFormat(Now(),'yyyy-mm-dd')#T#TimeFormat(Now(),'hh:mm:ss')#</ns:ShipTimestamp>
					<ns:DropoffType>REGULAR_PICKUP</ns:DropoffType>
					<ns:ServiceType>#ARGUMENTS.fedexServiceType#</ns:ServiceType>
					<ns:PackagingType>YOUR_PACKAGING</ns:PackagingType>
					...
					<ns:RequestedPackageLineItems>
						...
						<ns:Dimensions>
							<ns:Length>#trim(arguments.pkgLength)#</ns:Length>
							<ns:Width>#trim(arguments.pkgWidth)#</ns:Width>
							<ns:Height>#trim(arguments.pkgHeight)#</ns:Height>
...
--->		
	<cffunction name="processShipmentRequest" access="remote" returntype="struct" output="false">
		...
		<!---Build the XML Packet to send to FedEx--->
		<cfoutput>
		<cfsavecontent variable="XMLPacket"><SOAP-ENV:Envelope xmlns:SOAP-ENV="http://schemas.xmlsoap.org/soap/envelope/" xmlns:SOAP-ENC="http://schemas.xmlsoap.org/soap/encoding/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:ns="http://fedex.com/ws/ship/v10">
		<SOAP-ENV:Body>
		...
		<cfhttp url="#variables.fedexurl#/ship" port="443" method ="POST"> 
			<cfhttpparam name="name" type="XML" value="#trim(XMLPacket)#" /> 
		</cfhttp>
		...
		<cfset fedexReply.response =  variables.fedexurl />
		<cfset fedexReply.success = NOT err />
