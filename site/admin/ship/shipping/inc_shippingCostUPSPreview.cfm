...
<cfparam name="attributes.length" default="#sqlItem.depth#">



<cfif isdefined("form.Weight") and isnumeric(form.Weight)>
	<cfset attributes.weight = form.Weight >
</cfif>

<!--- this is used in shipping preview. form.dformWeight is submitted when preview buttons is clicked --->
...
<cfif isdefined("form.width") and isnumeric(form.width)>
	<cfset attributes.width = form.width >
</cfif>


<cfif isdefined("form.height") and isnumeric(form.height)>
	<cfset attributes.height = form.height >
</cfif>

<cfif isdefined("form.depth") and isnumeric(form.depth)>
	<cfset attributes.depth = form.depth >
</cfif>
...
<ShipmentConfirmRequest xml:lang="en-US">
	...
	<Shipment>
     ...
     <Dimensions>
       ...
       <Length>#attributes.length#</Length>
