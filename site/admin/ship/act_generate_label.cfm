...
<cfif _machine.cflocation EQ "">
	...
	<cfif sqlItem.weight gT 3> 
		<cfset _machine.cflocation = "index.cfm?dsp=admin.ship.fedex.FedexForm&item=#attributes.item#&maximize=#attributes.maximize#">
	<cfelseif sqlItem.weight LTE 3 >
		<cfset _machine.cflocation = "index.cfm?dsp=admin.ship.usps.request_label&item=#attributes.item#&maximize=#attributes.maximize#">
	<cfelse>
		<cfset _machine.cflocation = "index.cfm?dsp=admin.ship.confirm&item=#attributes.item#&maximize=#attributes.maximize#">
	</cfif>
</cfif>
