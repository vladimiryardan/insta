...
<tr><td>
	<font size="4"><strong>Paid and Shipped:</strong></font><br>
	...
	<tr>
		<td>
			<form method="POST" action="#_machine.self#">
				<input type="text" size="20" maxlength="30" name="srch" value="#HTMLEditFormat(attributes.srch)#">
...
<!---					OR
		...
		<tr bgcolor="##FFFFFF">
			...
			<td>
				...
				<cfelseif (sqlTemp.shipper EQ "FEDEX") AND (sqlTemp.tracking NEQ "")>
					<a href="https://www.fedex.com/apps/fedextrack/?tracknumbers=#sqlTemp.tracking#" target="_blank">#sqlTemp.tracking#</a>
				<cfelse>
					&nbsp;
				</cfif>
			</td>
			<td align="center">
				...
				<cfelseif (sqlTemp.shipper EQ "FEDEX") AND (sqlTemp.tracking NEQ "")>
					<a href="index.cfm?dsp=admin.ship.fedex.fedexPrintLabel&itemid=#sqlTemp.item#" target="_blank"><img src="#request.images_path#icon11.gif" border=0></a>
				<cfelse>
					&nbsp;
				</cfif>
			</td>
