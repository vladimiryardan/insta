...
<cfquery name="sqlTemp" datasource="#request.dsn#">
	SELECT i.item, i.ebayitem, i.title, i.lid, e.dtend, i.dlid
	FROM items i
		LEFT JOIN ebitems e ON i.ebayitem = e.ebayitem
	WHERE (i.status = 13)<!--- DONATED TO CHARITY --->
		AND (i.exception = 0)
		AND i.lid != 'DTC'
...
<tr><td>
	...
	<tr>
		<td align="left"><font size="4"><strong>Need to Donate:</strong></font><br></td>
	...
	<tr><td>
		...
		<cfelse>
			...
			<td class="ColHead"><a href="JavaScript: void fSort(4);">LID</a></td>
			<td class="ColHead"><a href="JavaScript: void fSort(6);">Date LID</a></td>
			<td class="ColHead"><a href="JavaScript: void fSort(5);">Date Ended</a></td>
			<td class="ColHead">Donate</td>
		</cfif>
		</tr>
		</cfoutput>
		<cfif NOT isDefined("attributes.printable")>
		...
		<tr bgcolor="##FFFFFF">
			...
			<td>#sqlTemp.title#</td>
			<td align="center">#sqlTemp.lid#</td>
			<td align="right" nowrap>#DateFormat(sqlTemp.dtend, "mmm d, yyyy")#</td>
			<td align="right" nowrap>#DateFormat(sqlTemp.dlid, "mmm d, yyyy")#</td>
		<cfif NOT isDefined("attributes.printable")>
			<td align="center"><input type="checkbox" value="#sqlTemp.item#" name="dtcITEMS"></td>
		</cfif>
		</tr>
		</cfoutput>
		<cfif NOT isDefined("attributes.printable")>
			<cfoutput>
			<tr bgcolor="##FFFFFF"><td colspan="7" align="right">
